---
title: "advanced_visualization_with_r_part_2_exercises"
output: html_document
---

```{r}

main_dir = "~/Applications/R/Project/advancedRViz"
...
# Answer: 
```{r}
fast_food = read.csv(file = "fast_food_data.csv", header = TRUE, stringsAsFactors = TRUE)
